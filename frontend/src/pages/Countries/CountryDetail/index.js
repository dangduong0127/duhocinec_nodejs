                ...
                <div className="container-cost-est-study-abroad">
                  <div className="col-cosr-est-study-abroad">
                    <div className="input-filed-cost-est">
                      ...
                      >
                        ...
                        <option value="300000000">Chứng Chỉ Sau Đại Học</option>
                      </select>
                    </div>
                    <div className="input-filed-cost-est">
                  ...
                  >
                    ...
                    <div className="hc-ph-11-container">
                      ...
                      <p className="tng-c-tnh">Tổng ước tính: 2,2 tỷ VND/năm</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div id="required-country">
              ...
              <pre className="pre-content">
                <p>
                  ...
                  IELTS, TOEFL (đối với tiếng Anh) hoặc TEF, TCF (đối với tiếng
                  Pháp). Ngoài ra, ứng viên cần cung cấp hồ sơ học tập và kinh
                  nghiệm làm việc liên quan (nếu có), đặc biệt quan trọng cho
                  các bậc sau đại học như thạc sĩ, tiến sĩ.
                </p>
              </pre>
                      ...
                      <div className="news-main-text">
                        <div className="news-content">
                          ...
                          <div className="news-excerpt">
                            ...
                            tin hữu ích về chính sách mới, có chiến lược tối ưu
                            bằng cấp, cơ hội việc làm và định cư. Cơ hội tư vấn
                            trực tiếp lộ trình chinh phục bằng Cử nhân danh giá
                            của top trường đại học hàng đầu xứ lá phong.
                          </div>
                        </div>
